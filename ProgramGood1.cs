...
namespace ConsoleAppl_CDP_Analysis_for_RR_problem1
{
    ...
    // *********************************************************************************************************************
    // *********************************************************************************************************************
    // *** by Vangelis Triantaphyllou, Baton Rouge, LA, February 11, 2022.                                               ***
    // *********************************************************************************************************************
    ...
    { // *** begin class MainProgram ***
        ...
        { // *** Begin Class ***
          // *** Local variable declarations *** 
            ...
            { // *** Begin Method *** 
                ...
                Adjust_a_Single_CDP_Matrix_with_RP_Violations_to_Derive_Closest_CDP_Matrix_with_No_RP_Violations_Demo object13 = new Adjust_a_Single_CDP_Matrix_with_RP_Violations_to_Derive_Closest_CDP_Matrix_with_No_RP_Violations_Demo();
                Determine_Distance_Between_Two_Priority_Vectors1_Demo object14 = new Determine_Distance_Between_Two_Priority_Vectors1_Demo(); 
                ...
                // ***************************************************************************************** 
                // *** Adjust the Saaty CDP matrix now since w eknow we have at least one RP violation!  ***

                object13.Adjust_a_Single_CDP_Matrix_with_RP_Violations_to_Derive_Closest_CDP_Matrix_with_No_RP_Violations(CDP_Matrix1, N, out CDP_Matrix_with_No_RP_Violations1) ;
                object6.Derive_The_Relative_Priorities_from_PC_Matrix1(CDP_Matrix_with_No_RP_Violations1, N, out Priority_Vector2);

                object14.Determine_Distance_Between_Two_Priority_Vectors1(Priority_Vector0, Priority_Vector1A, N, out Distance0_1A);
                object14.Determine_Distance_Between_Two_Priority_Vectors1(Priority_Vector0, Priority_Vector1B, N, out Distance0_1B);

                object14.Determine_Distance_Between_Two_Priority_Vectors1(Priority_Vector0, Priority_Vector2, N, out Distance02);

                Ratio_1A_2 = Distance0_1A / Distance02;
                Ratio_1B_2 = Distance0_1B / Distance02;
        ...
        // *********************************************************************************************************************
        class Adjust_Two_Values_so_They_Will_Satisfy_the_Reciprocal_Property2_Demo
        { // *** Begin Class ***
          // *** Local variable declarations *** 
            private int i;
            private double Inverse_Value1, Inverse_Value2, Average1a, Average2a, Average1b, Average2b, epsilon1, Diff1, Diff2;

            public void Adjust_Two_Values_so_They_Will_Satisfy_the_Reciprocal_Property2(double Input_Value1, double Input_Value2, out double Output_Value1, out double Output_Value2)
            { // *** Begin Method ***   
              // **************************************************************************************************************
              // *** As it was found by us recently, when an CDP matrix is formed, the reciprocal property may be violated. *** 
              // *** This "method" considers two non-recirocal values and goes through an iterative process to determine    *** 
              // *** the best pair of new values that: (1) satisfies th ereciprocal property and (2) is as close to the     ***
              // *** original pair as possible.  I hope to develop some theoretical approaches (i.e., a non-iterative one)  ***
              // *** that explicitly provides this pair by using functions and limits ideas via simple algebra.             *** 
              // ***                                                                                                        ***
              // ***   I AM NOT USING THIS METHOD ANY MORE!   BUT THE ONE DERIVED BY DOING SOME SIMPLE ALGEBRA!             ***
              // ***   THEY ARE BOTH EQUIVALENT!!!!!!!!                                                                     ***
              // ***                                                                                                        ***
              // **************************************************************************************************************

                epsilon1 = 0.000001; // *** This is a small positive value that serves as a threshold to declare  ***
                                     // *** two quantities are equal!                                             ***
                
                Average1a = Input_Value1;
                Average2a = Input_Value2;

                epsilon1 = 0.0;  // *** Is this a better approach than using a threshold value very close to 0?  ****

                // **************************************************************** 
                for (i = 1; i <= 100; i++)
                {
                    Inverse_Value1 = 1.00 / Input_Value1; 
                    Inverse_Value2 = 1.00 / Input_Value2;

                    Average1b = (Input_Value1 + Inverse_Value2) / 2.00;
                    Average2b = (Input_Value2 + Inverse_Value1) / 2.00;

                    Diff1 = Math.Abs(Average1a - Average1b);
                    Diff2 = Math.Abs(Average2a - Average2b);
    
                    if ((Diff1 <= epsilon1) & (Diff2 <= epsilon1))
                    {
                        goto Exit1;
                    };

                    // *** Update the values and iterate once more!  ***
                    Average1a = Average1b;
                    Average2a = Average2b;

                    Input_Value1 = Average1a;
                    Input_Value2 = Average2a;

                };

            Exit1: Output_Value1 = Average1a;
                   Output_Value2 = Average2a;
        ...
        // *********************************************************************************************************************
        class Adjust_Two_Values_so_They_Will_Satisfy_the_Reciprocal_Property_Demo
        { // *** Begin Class ***
          // *** Local variable declarations *** 
            private double Ratio_V1_by_V2, Ratio_V2_by_V1;

            public void Adjust_Two_Values_so_They_Will_Satisfy_the_Reciprocal_Property(double Input_Value1, double Input_Value2, out double Output_Value1, out double Output_Value2)
            { // *** Begin Method ***   
              // ******************************************************************************************************************
              // ***                                                                                                            ***          
              // *** As it was found by us recently, when a CDP matrix is formed, the reciprocal property may be violated.      ***
              // ***                                                                                                            ***
              // *** This "method" considers two non-recirocal values as input and goes through a simple algebraic              ***
              // *** transformation to solve a straighforward optimization problem to determine the MINIMALLY adjusted values!  ***
              // *** The details are explained in a paper of ours which now is under preparation.                               ***
              // ***                                                                                                            ***
              // *** You can see the logic by starting as out_V1 = Input_V1 x (X1).  out_V2 = Input_V2 x (X2), where X1 and X2  ***
              // *** are the adjustment coefficients.  Also that out_V1 = 1 / out_V2, and                                       ***
              // *** then realize (easy!) that X1 = X2! etc....                                                                 ***
              // ***                                                                                                            ***
              // ******************************************************************************************************************

                Ratio_V1_by_V2 = Input_Value1 / Input_Value2;
                Ratio_V2_by_V1 = 1.00 / Ratio_V1_by_V2;

                Output_Value1 = Math.Sqrt(Ratio_V1_by_V2);
                Output_Value2 = Math.Sqrt(Ratio_V2_by_V1);  
        ...
        // *********************************************************************************************************************
        class Adjust_a_Single_CDP_Matrix_with_RP_Violations_to_Derive_Closest_CDP_Matrix_with_No_RP_Violations_Demo
        { // *** Begin Class ***
          // *** Local variable declarations *** 
            private int i, i1, j;
            private double In_Value1, In_Value2, Out_Value1, Out_Value2, PC_Value1, PC_Value2 ;

            public void Adjust_a_Single_CDP_Matrix_with_RP_Violations_to_Derive_Closest_CDP_Matrix_with_No_RP_Violations(double [,] Input_CDP_Matrix1, int Size1, out double [,] Output_CDP_Matrix1)
            { // *** Begin Method ***   
                Output_CDP_Matrix1 = new double [30, 30];
                ...
                Adjust_Two_Values_so_They_Will_Satisfy_the_Reciprocal_Property_Demo object1 = new Adjust_Two_Values_so_They_Will_Satisfy_the_Reciprocal_Property_Demo();
                ...
                // THIS METHOD STILL NEEDS TO BE VALIDATED !!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!!! 
                ...
                // ********************************************************** 
                // *** Copy <Input_CDP_Matrix1> into <Output_CDP_Matrix1> *** 
                for (i = 1; i <= Size1; i++)
                {
                    for (j = 1; j <= Size1; j++)
                    {
                         Output_CDP_Matrix1[i, j] = Input_CDP_Matrix1[i, j] ;                         
                    };
                };

                // *************************************************************
                // *** Adjust the pairs of PCs that violate the RP property! ***
                for (i = 1; i < Size1; i++)
                {
                    i1 = i + 1;
                    for (j = i1; j <= Size1; j++)
                    {
                        PC_Value1 = Input_CDP_Matrix1[i, j];
                        PC_Value2 = Input_CDP_Matrix1[j, i]; // *** This is the reciprocal entry!  ***

                        if (PC_Value1 != (1.00/ PC_Value2) )
                        {
                            // *** Th eRP i sviolated!   Take proper action now!  ****
                            In_Value1 = PC_Value1;
                            In_Value2 = PC_Value2;
                            
                            object1.Adjust_Two_Values_so_They_Will_Satisfy_the_Reciprocal_Property(In_Value1, In_Value2, out Out_Value1, out Out_Value2);

                            Output_CDP_Matrix1[i, j] = Out_Value1;
                            Output_CDP_Matrix1[j, i] = Out_Value2; // *** This is the reciprocal PC! ***
                        };
                    };
                };
        ...
        // *********************************************************************************************************************
        class Explore_CDP_Matrix_Forced_Reciprocity_Adjustment_Idea1_Demo
        { // *** Begin Class ***
          // *** Local variable declarations *** 
            int i, N, Nmax, Nmin, Max_Number_of_Iterations1, Iterations1;
            int Number_of_RP_Violations1;
            int KCounter1a, KCounter1b;
            int KResult01, KResult02; 
            double In_Val1, In_Val2, Out_Val1, Out_Val2;
            double[,] CDP_Matrix1;
            //double[,] CDP_Matrix1 = new double[30, 30];

            double[,] CDP_Matrix_with_No_RP_Violations1 = new double[30, 30];

            double[,] CDP_Matrix_A1 = new double[30, 30];
            double[,] CDP_Matrix_B1 = new double[30, 30];
            ...
            double Sum_Sq_Differences_with_RP_Violations01, Sum_Sq_Differences_with_RP_Violations02, Sum_Sq_Differences_with_NO_RP_Violations01;

            double Normalized_Sq_Difference01, Normalized_Sq_Difference02;
            double Average_Normalized_Sq_Differences_with_RP_Violations01, Average_Normalized_Sq_Differences_with_RP_Violations02, Average_Normalized_Sq_Differences_with_NO_RP_Violations01;
            double Quantity1, Quantity2, Quantity3;

            string Output_Adjsusting_CDP_Analysis6_File;

            double SumA01, SumA02, SumB01, SumB02, SumC01, SumC02, Quantity4, Quantity5;

            int Ldummy1;

            public void Explore_CDP_Matrix_Forced_Reciprocity_Adjustment_Idea1()
            { // *** Begin Method ***   
              // **************************************************************************************************************
              // *** This method first generate an RCP and then the correspodning CDP matrix.  This is done by using the    ***
              // *** <Generate_a_Random_CDP_Matrix1> method.                                                                ***
              // *** After that it checks for at least one violation of the reciprocity property (= RP).                    ***
              // ***  If a CDP matrix exhibitts such violation, it is adjusted                                              ***
              // *** so it will have no reciprocity violations after that.                                                  ***
              // ***                                                                                                        ***
              // *** Statistics are collected on the number random RCP --> CDP matrices exhibit violations of the           ***
              // *** Reciprocity Property (RP) and then how RP-adjusted CDP matrices perform in terms of two criteria:      ***
              // ***                                                         (1) Rank violations (top alt. and any alt)     ***
              // ***            when compared to the original (hidden / unknown) ranking, and (2) squared difference to the ***
              // ***                                       original (hidden / unknown) and derived weights.                 ***
              // ***                                                                                                        ***
              // **************************************************************************************************************
                ...
                Scan_Pairwise_Matrix_for_Reciprocity_Violations1_Demo object2 = new Scan_Pairwise_Matrix_for_Reciprocity_Violations1_Demo();
                Adjust_a_Single_CDP_Matrix_with_RP_Violations_to_Derive_Closest_CDP_Matrix_with_No_RP_Violations_Demo object3 = new Adjust_a_Single_CDP_Matrix_with_RP_Violations_to_Derive_Closest_CDP_Matrix_with_No_RP_Violations_Demo();
                
                Derive_The_Relative_Priorities_from_PC_Matrix1_Demo object4 = new Derive_The_Relative_Priorities_from_PC_Matrix1_Demo();
                Derive_The_Rankings_from_Priority_Vector1_Demo object5 = new Derive_The_Rankings_from_Priority_Vector1_Demo();
                Compare_Two_Rankings1_Demo object6 = new Compare_Two_Rankings1_Demo();
                
                Determine_Distance_Between_Two_Priority_Vectors1_Demo object7 = new Determine_Distance_Between_Two_Priority_Vectors1_Demo();
                Derive_Two_CDP_Matrices_from_Single_CDP_Matrix1_Demo object8 = new Derive_Two_CDP_Matrices_from_Single_CDP_Matrix1_Demo();

                //....Print_Pairwise_Matrix1_Demo object8 = new Print_Pairwise_Matrix1_Demo(); 

                // *****************************************
                // *** End of object declaration section ***
                // *****************************************

                // ********************************************************************************************
                Output_Adjsusting_CDP_Analysis6_File = @"MyProjectFiles1\OUTPUT Adjusting CDPMatrix Analysis6.TXT";
                System.IO.StreamWriter file1 = new System.IO.StreamWriter(Output_Adjsusting_CDP_Analysis6_File);
                ...
                Nmin = 2;
                Max_Number_of_Iterations1 = 10000;  // THIS VALUE WILL CHANGE TO A LARGE POSITIV EINTEGER LATER!  Say, equal to 1 million? 

                Nmin = 2; Nmax = 20; Max_Number_of_Iterations1 = 100000;// THIS STATEMENT WILL BE REMOVED LATER! 


                Console.WriteLine("   N    Aver.w.NO.RPviolations   Aver.w.RPviolations_&_Saaty_CDP     Aver.w.RPviolations_&_Adjusted_CDP   SumA01 SumA02    SumB01 SumB02   SumC01 SumC02   Ratio12  Ratio_SumA02_A01  Ratio_SumB02_B01 KCounter1a  KCounter1b ");
                Console.WriteLine();



                file1.WriteLine(" ******************************************************************************* ");
                file1.WriteLine(" ***  This study explores what happens if we adjust all the PCs              *** ");
                file1.WriteLine(" ***  (= force reciprocity) that exhibit an RP violation.                    *** ");
                file1.WriteLine(" ***  This is my new idea for fixing AHP problems!                           *** ");
                file1.WriteLine(" ***  Vangelis, March 5, 2022.                                               *** ");
                file1.WriteLine(" ***  Number of Iterations = " + Max_Number_of_Iterations1);
                file1.WriteLine(" ******************************************************************************* ");
                file1.WriteLine("  ");
                file1.WriteLine("   N    Aver.w.NO.RPviolations   Aver.w.RPviolations_&_Saaty_CDP     Aver.w.RPviolations_&_Adjusted_CDP   SumA01 SumA02    SumB01 SumB02   SumC01 SumC02   Ratio12  Ratio_SumA02_A01  Ratio_SumB02_B01 KCounter1a  KCounter1b ");
                file1.WriteLine();
                ...
                for (N = Nmin; N <= Nmax; N++)
                {
                    ...
                    KCounter1a = 0; // *** Initialization.  This is the Counter of CDP Matrices that exhibit at least one RP violation! ***
                    KCounter1b = 0; // *** Initialization.  This is the Counter of CDP Matrices that exhibit NO           RP violation! ***

                    Sum_Sq_Differences_with_RP_Violations01 = 0.00;    // *** Initialization.  This is the sum of squared differences between Vector0 and the one from the initial CDP matrix ***
                    Sum_Sq_Differences_with_RP_Violations02 = 0.00;    // *** Initialization.  This is the sum of squared differences between Vector0 and the one from the Adjusted (i.e., witout RP problem) CDP matrix ***
                    Sum_Sq_Differences_with_NO_RP_Violations01 = 0.00; // *** Initialization.  This is the sum of squared differences between Vector0 and the one from the initial CDP matrix but NO RP is detected. ***
                    SumA01 = 0.00; SumA02 = 0.0; // *** Initializations 
                    SumB01 = 0.00; SumB02 = 0.0;
                    SumC01 = 0.00; SumC02 = 0.0;

                    for (Iterations1 = 1; Iterations1 <= Max_Number_of_Iterations1; Iterations1++)
                    {
                    ...
                    goto Jump1; 
                        ...
                        Console.WriteLine();
                        Console.WriteLine(" %%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%% ");
                        Console.WriteLine("  Iteration No ---> " + Iterations1);  
                       // Console.WriteLine(" This is the TRUE (and thus hidden) priority values ");
                       // for (i=1; i<= N; i++)
                       // {
                       //     Console.WriteLine("  i --> " + i + "  Priority_Vector0[i] = " + Priority_Vector0[i]);
                       // };
                        Console.WriteLine();
                        Console.WriteLine(" This is the CDP matrix derived from the original RCP matrix ");
                        pr1.Print_Pairwise_Matrix1(CDP_Matrix1, N);

                        Console.WriteLine("   ");

                    Jump1: Ldummy1 = 99; // A dummy statement for my Jump task.... 

                        object2.Scan_Pairwise_Matrix_for_Reciprocity_Violations1(CDP_Matrix1, N, out Number_of_RP_Violations1);

                    goto Jump2;
                        Console.WriteLine("   Number of RP Violations = " + Number_of_RP_Violations1);
                        Console.WriteLine("  ");
                        Console.WriteLine();
                        
                    Jump2: Ldummy1 = 99; // A dummy statement for my Jump task.... 

                        if (Number_of_RP_Violations1 > 0)
                        {
                            // *** We found a CDP matrix with at least one RP violation!  *** 
                        
                            object3.Adjust_a_Single_CDP_Matrix_with_RP_Violations_to_Derive_Closest_CDP_Matrix_with_No_RP_Violations(CDP_Matrix1, N, out CDP_Matrix_with_No_RP_Violations1) ;

                            object8.Derive_Two_CDP_Matrices_from_Single_CDP_Matrix1(CDP_Matrix1, N, out CDP_Matrix_A1, out CDP_Matrix_B1);


                        goto Jump3;
                            Console.WriteLine();
                            Console.WriteLine(" This is the CDP matrix derived AFTER we adjusted for the RP violations! ");
                            pr1.Print_Pairwise_Matrix1(CDP_Matrix_with_No_RP_Violations1, N);
                            Console.WriteLine();
                            Console.WriteLine("   ");

                        Jump3: Ldummy1 = 99; // A dummy statement for my Jump task.... 


                            // ********************************************************************** 
                            // *** Now we get the priority vectors and the corresponding rankings ***
                            //.. object4.Derive_The_Relative_Priorities_from_PC_Matrix1(CDP_Matrix1, N, out Priority_Vector1) ;
                            object4.Derive_The_Relative_Priorities_from_PC_Matrix1(CDP_Matrix_A1, N, out Priority_Vector1); // <----  We used the traditional SAATY approach here!  

                            object4.Derive_The_Relative_Priorities_from_PC_Matrix1(CDP_Matrix_with_No_RP_Violations1, N, out Priority_Vector2) ;


                        goto Jump4;
                            Console.WriteLine("  We have a case with at least one RP violation now!!! ");
                            Console.WriteLine(" ***** Next are vectors Vector0, Vector1 and Vector2");
                            for (i=1;i <= N;i++)
                            {
                                Console.WriteLine("  i --> " + i + "  " + Priority_Vector0[i] + "  " + Priority_Vector1[i] + "  " + Priority_Vector2[i]);
                            };

                        Jump4: Ldummy1 = 99; // A dummy statement for my Jump task.... 


                            object5.Derive_The_Rankings_from_Priority_Vector1(Priority_Vector0, N, out Ranking_R0);
                            object5.Derive_The_Rankings_from_Priority_Vector1(Priority_Vector1, N, out Ranking_R1);
                            object5.Derive_The_Rankings_from_Priority_Vector1(Priority_Vector2, N, out Ranking_R2);



                        goto Jump5;
                            Console.WriteLine();
                            Console.WriteLine(" ***** Next are the corresponding three rankings:  R0, R1, and R2");
                            for (i = 1; i <= N; i++)
                            {
                                Console.WriteLine("  i --> " + i + "    Rankings: " + Ranking_R0[i] + "  " + Ranking_R1[i] + "  " + Ranking_R2[i]);
                            };
                            Console.WriteLine();

                        Jump5: Ldummy1 = 99; // A dummy statement for my Jump task.... 


                            // ***************************************
                            // *** Now we compare the two rankings ***
                            object6.Compare_Two_Rankings1(Ranking_R0, Ranking_R1, N, out KResult01) ;
                            object6.Compare_Two_Rankings1(Ranking_R0, Ranking_R2, N, out KResult02);

                            //Console.WriteLine("    within SOS POINT = P1:   KResult01, KResult02 = " + KResult01 + "   " + KResult02);
                            //file1.WriteLine("    within SOS POINT = P1:   KResult01, KResult02 = " + KResult01 + "   " + KResult02);
                            ...
                            // *******************************************************************************************
                            // *** Determine the distance between the two priority vectors.                            ***
                            // *** This is the sum of the squared distances and then normalized (i.e., divided by N).  ***
                            object7.Determine_Distance_Between_Two_Priority_Vectors1(Priority_Vector0, Priority_Vector1, N, out Normalized_Sq_Difference01);
                            object7.Determine_Distance_Between_Two_Priority_Vectors1(Priority_Vector0, Priority_Vector2, N, out Normalized_Sq_Difference02);

                            // *****************************************************  
                            // *** Now we update our counters and result records *** 
                            KCounter1a = KCounter1a + 1;  // *** This counts th enumber we find CDP matrices with RP violations ***
                            Sum_Sq_Differences_with_RP_Violations01 = Sum_Sq_Differences_with_RP_Violations01 + Normalized_Sq_Difference01;
                            Sum_Sq_Differences_with_RP_Violations02 = Sum_Sq_Differences_with_RP_Violations02 + Normalized_Sq_Difference02;

                            double Ratio1;
                            Ratio1 = Normalized_Sq_Difference01 / Normalized_Sq_Difference02;

                        goto Jump5_a;
                            Console.WriteLine();
                            Console.WriteLine("   Normalized SQ  Distance01 = " + Normalized_Sq_Difference01 + "   Normalized SQ  Distance02 = " + Normalized_Sq_Difference02);
                            Console.WriteLine("   Ratio1 =====> " + Ratio1);
                            Console.WriteLine();

                        Jump5_a: Ldummy1 = 99; // A dummy statement for my Jump task.... 
                        ...
                        if (Number_of_RP_Violations1 == 0)
                        {
                            // *** We found a CDP matrix with NO__________RP violation!  *** 
                            KCounter1b = KCounter1b + 1;
                            //object3.Adjust_a_Single_CDP_Matrix_with_RP_Violations_to_Derive_Closest_CDP_Matrix_with_No_RP_Violations(CDP_Matrix1, N, CDP_Matrix_with_No_RP_Violations1);

                            // ************************************************************************** 
                            // *** Now we get the two priority vectors and the corresponding rankings ***
                            object4.Derive_The_Relative_Priorities_from_PC_Matrix1(CDP_Matrix1, N, out Priority_Vector1);
                            //object4.Derive_The_Relative_Priorities_from_PC_Matrix1(CDP_Matrix_with_No_RP_Violations1, N, Priority_Vector1);
                            ...
                            goto Jump6;
                            Console.WriteLine("  We have a case with NO RP violations!!! ");
                            Console.WriteLine(" ***** Next are vectors Vector0 and Vector1");
                            for (i = 1; i <= N; i++)
                            {
                               Console.WriteLine("  i --> " + i + "  " + Priority_Vector0[i] + "  " + Priority_Vector1[i] );
                            };

                            Console.WriteLine();
                            Console.WriteLine(" ***** Next are the corresponding two rankings:  R0 and R1");
                            for (i = 1; i <= N; i++)
                            {
                                Console.WriteLine("  i --> " + i + "    Rankings: " + Ranking_R0[i] + "  " + Ranking_R1[i]);
                            };
                            Console.WriteLine();

                        Jump6: Ldummy1 = 99; // A dummy statement for my Jump task.... 
                            ...
                            // *****************************************************                
                            // *** Now we update our counters and result records *** 
                            Sum_Sq_Differences_with_NO_RP_Violations01 = Sum_Sq_Differences_with_NO_RP_Violations01 + Normalized_Sq_Difference01;

                        goto Jump7;
                            Console.WriteLine();
                            Console.WriteLine("   Normalized SQ  Distance01 = " + Normalized_Sq_Difference01 );
                            Console.WriteLine();

                        Jump7: Ldummy1 = 99; // A dummy statement for my Jump task.... 
                    ...
                    Average_Normalized_Sq_Differences_with_RP_Violations01 = Sum_Sq_Differences_with_RP_Violations01 / (1.0 * Max_Number_of_Iterations1);
                    Average_Normalized_Sq_Differences_with_RP_Violations02 = Sum_Sq_Differences_with_RP_Violations02 / (1.0 * Max_Number_of_Iterations1);
                    Average_Normalized_Sq_Differences_with_NO_RP_Violations01 = Sum_Sq_Differences_with_NO_RP_Violations01 / (1.0 * Max_Number_of_Iterations1);

                    Quantity1 = Average_Normalized_Sq_Differences_with_RP_Violations01;
                    Quantity2 = Average_Normalized_Sq_Differences_with_RP_Violations02;
                    Quantity3 = Average_Normalized_Sq_Differences_with_NO_RP_Violations01;

                    double Ratio12, Ratio23, Ratio_SumA02_A01, Ratio_SumB02_B01 ;
                    Ratio12 = Quantity1 / Quantity2;
                    //Ratio23 = Quantity2 / Quantity3; 
                    Ratio_SumA02_A01 = SumA02 / SumA01;
                    Ratio_SumB02_B01 = SumB02 / SumB01;

                    //Console.WriteLine("   N    Aver.w.NO.RPviolations   Aver.w.RPviolations_&_Saaty_CDP     Aver.w.RPviolations_&_Adjusted_CDP   SumA01 SumA02    SumB01 SumB02   SumC01 SumC02   Ratio12  Ratio_SumA02_A01  Ratio_SumB02_B01 KCounter1a  KCounter1b ");
                    //Console.WriteLine("          SumA01, SumA02 (= agree100% with true) " + SumA01 + "  " + SumA02 + "     SumB01, SumB02 (= agree TOP but not 100% with true) " + SumB01 + "  " + SumB02 + "     SumC01, SumC02 (= disagree with true) " + SumC01 + "  " + SumC02);
 
                    Console.WriteLine(" " + N + "  " + Quantity3 + "    " + Quantity1 + "  " + Quantity2 + "       " + SumA01 + "  " + SumA02 + "    " + SumB01 + "  " + SumB02 + "     " + SumC01 + "  " + SumC02 + "  "  + Ratio12+ "  " + Ratio_SumA02_A01 + "  " + Ratio_SumB02_B01 + "   " + KCounter1a + "    " + KCounter1b);
                    
                    //Console.WriteLine("   Ratio23 (= Aver SQ Diffs w. Adjusted RPs / Aver SQ with NO       RPs =============> " + Ratio23);

                    // Console.WriteLine();

                    //file1.WriteLine("   N    Aver.w.NO.RPviolations   Aver.w.RPviolations_&_Saaty_CDP     Aver.w.RPviolations_&_Adjusted_CDP   SumA01 SumA02    SumB01 SumB02   SumC01 SumC02   Ratio12  Ratio_SumA02_A01  Ratio_SumB02_B01 KCounter1a  KCounter1b ");                 
                    
                    file1.WriteLine(" " + N + "  " + Quantity3 + "    " + Quantity1 + "  " + Quantity2 + "       " + SumA01 + "  " + SumA02 + "    " + SumB01 + "  " + SumB02 + "     " + SumC01 + "  " + SumC02 + "  " + Ratio12 + "  " + Ratio_SumA02_A01 + "  " + Ratio_SumB02_B01 + "   " + KCounter1a + "    " + KCounter1b);


                    // file1.WriteLine("   N -- " + N + "  Aver. When NO RP occurs = " + Quantity3 + " Aver. when RP occurs w. initial CDP = " + Quantity1 + " Aver. when RP occurs w. Adjusted CDP = " + Quantity2);
                    // file1.WriteLine("          SumA01, SumA02 (= agree100% with true) " + SumA01 + "  " + SumA02 + "     SumB01, SumB02 (= agree TOP but not 100% with true) " + SumB01 + "  " + SumB02 + "     SumC01, SumC02 (= disagree with true) " + SumC01 + "  " + SumC02);


                    // file1.WriteLine();
                    // file1.WriteLine("   Ratio12 (= Aver SQ Diffs w. RPs / Aver SQ with adjusted RPs =============> " + Ratio12);
                    // file1.WriteLine("   Ratio SumA02/SumA01 = " + Ratio_SumA02_A01 + "  Ratio SumB02 / SumB01 = " + Ratio_SumB02_B01);
                    // file1.WriteLine("     Cases with RP violations = " + KCounter1a + "   Cases with NO RP violations = " + KCounter1b);

                    // file1.WriteLine("   Ratio12 (= Aver SQ Diffs w. RPs / Aver SQ with adjusted RPs =============> " + Ratio12);
                    // file1.WriteLine("   Ratio SumA02/SumA01 = " + Ratio_SumA02_A01 + "  Ratio SumB02 / SumB01 = " + Ratio_SumB02_B01);
                    // file1.WriteLine("     Cases with RP violations = " + KCounter1a + "   Cases with NO RP violations = " + KCounter1b);

                    //file1.WriteLine("   Ratio23 (= Aver SQ Diffs w. Adjusted RPs / Aver SQ with NO       RPs =============> " + Ratio23);
                    // file1.WriteLine("   ************************************************ ");
                    // file1.WriteLine();
                    // file1.WriteLine();
                ...
                //Adjust_Two_Values_so_They_Will_Satisfy_the_Reciprocal_Property_Demo object11 = new Adjust_Two_Values_so_They_Will_Satisfy_the_Reciprocal_Property_Demo();

                //In_Val1 = 1.00;
                //In_Val2 = 1.00 / 2.00; 

                // object11.Adjust_Two_Values_so_They_Will_Satisfy_the_Reciprocal_Property(In_Val1, In_Val2, out Out_Val1, out Out_Val2);
...
public void Explore_Stochastic_Nature_via_Simulation_and_Petrubations_of_RCP_Matrices1()
        ...
        { // *** Begin Class ***
          // *** Local variable declarations *** 
            ...
            { // *** Begin Method *** 
                ...
                Adjust_a_Single_CDP_Matrix_with_RP_Violations_to_Derive_Closest_CDP_Matrix_with_No_RP_Violations_Demo object6 = new Adjust_a_Single_CDP_Matrix_with_RP_Violations_to_Derive_Closest_CDP_Matrix_with_No_RP_Violations_Demo();
                ...
                if (No_of_RP_Cases1 > 0)
                { // *** We have some RP violation(s)!  Thus, need to adjust the CDP matrix 
                    object6.Adjust_a_Single_CDP_Matrix_with_RP_Violations_to_Derive_Closest_CDP_Matrix_with_No_RP_Violations(CDP_Matrix0, Size1, out CDP_Matrix1);
                }
                else
                { // *** We have *NO* RP violation(s)!  Thus, no need to adjust the CDP matrix.  Just copy it a sit is!  
                    object8.Copy_PC_Matrix1(Size1, CDP_Matrix0, out CDP_Matrix1);
                };
                ...
                RRatio1 = Diff_Real_and_CDP1 / Difference_Sim02;       // *** Ratio between  Real      &   adjusted CDP approach  ***
                RRatio2 = Diff_Real_and_Saaty1 / Diff_Real_and_CDP1;   // *** Ratio between  Saaty's   &   adjusted CDP approach.  The bigger the better!  ***
                RRatio3 = Diff_Real_and_Saaty1 / Difference_Sim02;     // *** Ratio between  Saaty's   &   simulation   approach  *** 
        ...
        { // *** Begin Class ***
          ...
          private double Old_Value1, New_Value1;
            ...
            { // *** Begin Method *** 
                ...
                // *** Object declaration section ***
                // **********************************
                Adjust_a_Single_CDP_Matrix_with_RP_Violations_to_Derive_Closest_CDP_Matrix_with_No_RP_Violations_Demo object1 = new Adjust_a_Single_CDP_Matrix_with_RP_Violations_to_Derive_Closest_CDP_Matrix_with_No_RP_Violations_Demo();
                Scan_Pairwise_Matrix_for_Reciprocity_Violations1_Demo object2 = new Scan_Pairwise_Matrix_for_Reciprocity_Violations1_Demo();
                Copy_PC_Matrix1_Demo object3 = new Copy_PC_Matrix1_Demo();
                ...
                // *** We check this pertrubed PC matrixfor RP violations and adjust it accordingly!
                object2.Scan_Pairwise_Matrix_for_Reciprocity_Violations1(Pertrubed_PC_Matrix1, Size1, out No_of_RP_Cases1);

                if (No_of_RP_Cases1 > 0)
                {  // *** We have at least one RP violation!  We need to adjust th einitial pertrubed PC matrix! ***
                    object1.Adjust_a_Single_CDP_Matrix_with_RP_Violations_to_Derive_Closest_CDP_Matrix_with_No_RP_Violations(Pertrubed_PC_Matrix0, Size1, out Pertrubed_PC_Matrix1);
                }
                else
                {  // *** No need for adjustment.  Just copy the matrix into the output matrix! ***
                    object3.Copy_PC_Matrix1(Size1, Pertrubed_PC_Matrix0, out Pertrubed_PC_Matrix1);
                };
        ...
        public static void Main(string[] args)
        {
            ...
            Explore_CDP_Matrix_Forced_Reciprocity_Adjustment_Idea1_Demo object9 = new Explore_CDP_Matrix_Forced_Reciprocity_Adjustment_Idea1_Demo();
            ...
            //goto Jump1;   
            // &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
            // *** Below I explore whether my iterative approach is close (identical?) to the optimization model I came up with. ***
            // *** Actually, it is!!!!                                                                                             ***
            // *** This is great news!!!                                                                                           ***
            //
            //  Adjust_Two_Values_so_They_Will_Satisfy_the_Reciprocal_Property_Demo object11 = new Adjust_Two_Values_so_They_Will_Satisfy_the_Reciprocal_Property_Demo();
            ...
            //object11.Adjust_Two_Values_so_They_Will_Satisfy_the_Reciprocal_Property(In_Val1, In_Val2, out Out_Val1, out Out_Val2);
            //Console.WriteLine();
            //Console.WriteLine("  In_Val1 and In_Val2   =   " + In_Val1 + "  " + In_Val2);
            //Console.WriteLine("  Out_Val1 and Out_Val2 ==> " + Out_Val1 + "  " + Out_Val2);
            //Console.WriteLine();
            //
            //
            //
            //
            //Console.WriteLine("   Under the Old method ");
            //           
            //Adjust_Two_Values_so_They_Will_Satisfy_the_Reciprocal_Property2_Demo object11a = new Adjust_Two_Values_so_They_Will_Satisfy_the_Reciprocal_Property2_Demo();
            //object11a.Adjust_Two_Values_so_They_Will_Satisfy_the_Reciprocal_Property2(In_Val1, In_Val2, out Out_Val1, out Out_Val2);
            //
            //Console.WriteLine();
            //Console.WriteLine("  In_Val1 and In_Val2   =   " + In_Val1 + "  " + In_Val2);
            //Console.WriteLine("  Out_Val1 and Out_Val2 ==> " + Out_Val1 + "  " + Out_Val2);
            //Console.WriteLine();
            //
            //      object9.Explore_CDP_Matrix_Forced_Reciprocity_Adjustment_Idea1();
            //
            // int i1;
            //
            // &&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&& 
            //Jump1: i1 = 9; // *** A dummy statement for this jump! 
